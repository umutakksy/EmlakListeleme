...
public class EmlakManager {
    ...
    public void ornekVerilerEkle() {
        Emlak emlak1 = new Emlak("Güzel Daire", "Daire", "İstanbul", "Kadıköy Merkez", 1250000, 120, "3");
        Emlak emlak2 = new Emlak("Modern Villa", "Villa", "Antalya", "Lara Sahil", 3500000, 250, "5+");
        Emlak emlak3 = new Emlak("Ofis Kiralık", "İşyeri", "Ankara", "Çankaya Plaza", 8000, 80, "1");
